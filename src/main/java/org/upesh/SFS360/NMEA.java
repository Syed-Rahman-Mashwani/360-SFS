 ...
 * 
 * To parse NMEA code sent from GPS device, I am using NMEA (third party) Class.
 * Downloaded from https://gist.github.com/javisantana/1326141 and slightly modified to meet the requirements
 * this software (NMEA.java) is under the terms of MIT license: http://opensource.org/licenses/MIT
 * 
 */
